...
function initPostToCategory(categorySlug, callback) {
  ...
  fetch(`https://public-api.wordpress.com/rest/v1.1/sites/${blogName}/posts/?category=${categorySlug}&order=ASC&fields=ID,title,categories,slug&number=100`)
...
export function getCategories() {
  ...
  return function(dispatch, getState) {
    ...
    fetch(`https://public-api.wordpress.com/rest/v1.1/sites/${blogName}/categories`)
      .then((response) => response.json())
      .then((json) => {
